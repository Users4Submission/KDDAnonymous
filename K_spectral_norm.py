...
class SpectralNorm:
    ...
    def __init__(self, name: str = 'weight', n_power_iterations: int = 1, dim: int = 0, eps: float = 1e-12, L=1) -> None:
        self.name = name
        self.dim = dim
    ...
    def compute_weight(self, module: Module, do_power_iteration: bool) -> torch.Tensor:
        ...
        weight = weight / max((sigma / self.L), 1)
        return weight
    ...
    @staticmethod
    def apply(module: Module, name: str, n_power_iterations: int, dim: int, eps: float, L: float) -> 'SpectralNorm':
...
def spectral_norm(module: T_module,
    ...
    if dim is None:
        if isinstance(module, (torch.nn.ConvTranspose1d,
            ...
            dim = 0
    SpectralNorm.apply(module, name, n_power_iterations, dim, eps, L)
    return module
